...
function(backtasty, Backbone) {

  // Create a new module
  var Example = backtasty.module();
  ...
  Example.Views.Tutorial = Backbone.View.extend({
    ...
    render: function(done) {
      ...
      backtasty.fetchTemplate(this.template, function(tmpl) {
...
define("backbone_tastypie", function(){});

define('use!backbone_tastypie', ['use!backbone','use!underscore','jquery'],function() {return window['Backbone'];});

define('icanhaz',["require", "exports", "module"], function(require, exports, module) {
/*!
...
define('use!icanhaz', ['jquery'],function() {return window['ich'];});

define('modules/tweet',[
  "backtasty",
